...
const string strMessageMagic = "teamup Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "teamup", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sat, 08 Oct 2016 11:00:19 GMT";
        CTransaction txNew;
        txNew.nTime = 1475924410;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("e6b62fd3f7e6f4d4d8ede22aee4d1f09b0c4fd69ab0aa407facc06755962512b"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x5a, 0x3c, 0xa4, 0xb2 };
